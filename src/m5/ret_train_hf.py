...
def contrastive_loss_m5(im_emb, tex_emb, logit_scale):
    logits = logit_scale.exp() * (im_emb @ tex_emb.T)
...
def init_m5_model_and_optimizer(vocab_size, device, lr=1e-4):
...
txt_enc = TextEncoder(vocab_size=1000)
